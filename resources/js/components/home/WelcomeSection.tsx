...
const WelcomeSection: React.FC = () => {
  return (
    <motion.div
      // Estrechar la sección con un max-w-2xl y ajustar el padding
      className="flex flex-col items-center text-center max-w-2xl mx-auto space-y-6 px-6 py-10" // Ajustado para ser más compacto
      initial={{ opacity: 0 }}
    ...
    >
      ...
      <div className="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-8 mt-8"> {/* Mayor separación y responsividad */}
        <motion.div whileHover={{ scale: 1.05 }} transition={{ type: "spring", stiffness: 300 }}>
          <Link
            to="/shop" // Enlace a la tienda de bicicletas
        ...
        <motion.div whileHover={{ scale: 1.05 }} transition={{ type: "spring", stiffness: 300 }}>
          <Link
            to="/workshop" // Enlace al taller (cambiado de /taller a /workshop, ajusta si tu ruta es diferente)
